...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: MyHomePage(title: 'Danh bạ điện thoại'),
    );
  }
}
      ...
      body: Container(
        ...
        child: Column(
          children: <Widget>[
            ...
            contactsLoaded == true
                ? // nếu danh bạ chưa được tải
                listItemsExist == true
                    ? // nếu có địa chỉ liên hệ để hiển thị
                    ContactsList(
                        reloadContacts: () {
                          getAllContacts();
                        },
                    ...
                    : Container(
                        ...
                        child: Text(
                          isSearching
                              ? 'Không có kết quả tìm kiếm nào để hiển thị'
                              : 'Không có địa chỉ liên hệ nào tồn tại',
                          style: TextStyle(color: Colors.grey, fontSize: 20),
                        ))
                : Container(
                    // vẫn đang tải danh bạ
                    padding: EdgeInsets.only(top: 40),
                    child: Center(
